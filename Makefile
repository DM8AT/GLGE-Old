...
$(OBJ_D)/3DTest.o: $(SRC)/3DTest.cpp $(SRC)/3DTest.hpp $(GLGE_ALL_FILES) $(CML_ALL_FILES)
	$(CXX) -c $< -o $@ $(CXX_FLAGS)
...
$(OBJ_D)/openglGLGE2Dcore.o: $(GLGE_OGL)/openglGLGE2Dcore.cpp $(GLGE_OGL)/openglGLGE2Dcore.h $(GLGE_IND)/glge2DcoreDefClasses.cpp $(GLGE_IND)/glge2DcoreDefClasses.h $(GLGE_OGL)/openglGLGE.cpp $(GLGE_OGL)/openglGLGE.h $(GLGE_OGL)/openglGLGEDefines.hpp $(GLGE_IND)/glgePrivDefines.hpp $(GLGE_OGL)/openglGLGEFuncs.cpp $(GLGE_OGL)/openglGLGEFuncs.hpp $(GLGE_OGL)/openglGLGEVars.cpp $(GLGE_OGL)/openglGLGEVars.hpp $(GLGE_IND)/GLGEData.cpp $(GLGE_IND)/GLGEData.h
	$(CXX) -c $< -o $@ $(CXX_FLAGS)
# Dep. on glgeVars openglGLGEFuncs openglGLGEVars CMLQuaternion openglGLGEMaterialCore openglGLGEShaderCore openglGLGE glge3DcoreDefClasses
$(OBJ_D)/openglGLGE3Dcore.o: $(GLGE_OGL)/openglGLGE3Dcore.cpp $(GLGE_OGL)/openglGLGE3Dcore.h $(GLGE_IND)/glgeVars.cpp $(GLGE_IND)/glgeVars.hpp $(GLGE_OGL)/openglGLGEFuncs.cpp $(GLGE_OGL)/openglGLGEFuncs.hpp $(GLGE_OGL)/openglGLGEVars.cpp $(GLGE_OGL)/openglGLGEVars.hpp $(CML)/CMLQuaternion.cpp $(CML)/CMLQuaternion.h $(GLGE_OGL)/openglGLGEMaterialCore.cpp $(GLGE_OGL)/openglGLGEMaterialCore.h $(GLGE_OGL)/openglGLGEShaderCore.cpp $(GLGE_OGL)/openglGLGEShaderCore.h $(GLGE_OGL)/openglGLGE.cpp $(GLGE_OGL)/openglGLGE.h $(GLGE_IND)/glge3DcoreDefClasses.cpp $(GLGE_IND)/glge3DcoreDefClasses.h
	$(CXX) -c $< -o $@ $(CXX_FLAGS)
...
$(OBJ_D)/openglGLGELightingCore.o: $(GLGE_OGL)/openglGLGELightingCore.cpp $(GLGE_OGL)/openglGLGELightingCore.h $(GLGE_OGL)/openglGLGEVars.cpp $(GLGE_OGL)/openglGLGEVars.hpp $(GLGE_OGL)/openglGLGEFuncs.cpp $(GLGE_OGL)/openglGLGEFuncs.hpp $(CML)/CMLMat4.cpp $(CML)/CMLMat4.h
	$(CXX) -c $< -o $@ $(CXX_FLAGS)
# Dep. on CML_ALL openglGLGE openglGLGEVars
$(OBJ_D)/openglGLGEMaterialCore.o: $(GLGE_OGL)/openglGLGEMaterialCore.cpp $(GLGE_OGL)/openglGLGEMaterialCore.h $(CML_ALL_FILES) $(GLGE_OGL)/openglGLGE.cpp $(GLGE_OGL)/openglGLGE.h $(GLGE_OGL)/openglGLGEVars.cpp $(GLGE_OGL)/openglGLGEVars.hpp
	$(CXX) -c $< -o $@ $(CXX_FLAGS)
...
$(OBJ_D)/openglGLGEShaderCore.o: $(GLGE_OGL)/openglGLGEShaderCore.cpp $(GLGE_OGL)/openglGLGEShaderCore.h $(CML_ALL_FILES) $(GLGE_OGL)/openglGLGEVars.cpp $(GLGE_OGL)/openglGLGEVars.hpp $(GLGE_OGL)/openglGLGEFuncs.cpp $(GLGE_OGL)/openglGLGEFuncs.hpp $(GLGE)/GLGEMath.cpp $(GLGE)/GLGEMath.h
	$(CXX) -c $< -o $@ $(CXX_FLAGS)
...
$(OBJ_D)/openglGLGEWindow.o: $(GLGE_OGL)/openglGLGEWindow.cpp $(GLGE_OGL)/openglGLGEWindow.h $(GLGE_OGL)/openglGLGELightingCore.cpp $(GLGE_OGL)/openglGLGELightingCore.h $(GLGE_OGL)/openglGLGE3Dcore.cpp $(GLGE_OGL)/openglGLGE3Dcore.h $(GLGE_OGL)/openglGLGE2Dcore.cpp $(GLGE_OGL)/openglGLGE2Dcore.h $(CML)/CMLVec2.cpp $(CML)/CMLVec2.h $(CML)/CMLVec3.cpp $(CML)/CMLVec3.h $(GLGE_OGL)/openglGLGEVars.cpp $(GLGE_OGL)/openglGLGEVars.hpp $(GLGE_OGL)/openglGLGEFuncs.cpp $(GLGE_OGL)/openglGLGEFuncs.hpp $(GLGE_IND)/glgeImage.cpp $(GLGE_IND)/glgeImage.h
	$(CXX) -c $< -o $@ $(CXX_FLAGS)
